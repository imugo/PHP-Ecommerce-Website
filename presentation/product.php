<?php
	class Product {
		// Public variables to be used in template
		public $mProduct;
		...
		public function init() {
			...
			// Build links for product department and category pages
			for ($i=0; $i<count($this->mLocations); $i++) {
				...
				$this->mLocations[$i]['link_to_index'] = Link::Build('');	
			}
